        ...
        <div className="max-w-7xl mx-auto space-y-16 sm:space-y-20">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
              {/* Platinum Sponsor 1 */}
              <div className="bg-black/60 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-gray-400/30 text-center hover:border-gray-300/50 transition-all duration-300">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
              {/* Gold Sponsor 1 */}
              <div className="bg-black/60 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-yellow-500/30 text-center hover:border-yellow-400/50 transition-all duration-300">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {/* Bronze Sponsor 1 */}
              <div className="bg-black/60 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-amber-500/30 text-center hover:border-amber-400/50 transition-all duration-300">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center space-x-2 text-amber-400 hover:text-amber-300 transition-colors text-xs sm:text-sm"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg>
          ...
          <section className="text-center">
            <div className="bg-black/60 backdrop-blur-sm rounded-2xl p-8 sm:p-10 border border-purple-500/30 max-w-3xl mx-auto">
              ...
              <a
                ...
                className="bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 sm:px-10 py-4 sm:py-5 rounded-xl font-bold text-lg sm:text-xl transition-all duration-300 transform hover:scale-105 inline-block"
              >
