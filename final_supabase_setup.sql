-- =========================================
-- Techverse 2026 Final Database Setup
...
CREATE TABLE IF NOT EXISTS public.registrations (
    ...
    business_idea JSONB, -- {title, description, problem, solution, market_size, target_audience, competitive_advantage, revenue_model, final_submission}
...
-- =========================================
-- 3. Create Business Innovation Evaluations Table
-- =========================================
...
DROP POLICY IF EXISTS "Allow users to view own registration" ON public.registrations;
DROP POLICY IF EXISTS "Allow authenticated updates" ON public.registrations;
DROP POLICY IF EXISTS "Allow authenticated admins to read own credentials" ON public.admin_credentials;
DROP POLICY IF EXISTS "Allow login access" ON public.admin_credentials;
DROP POLICY IF EXISTS "Allow super admins to manage admin credentials" ON public.admin_credentials;
DROP POLICY IF EXISTS "Allow authenticated evaluators to insert evaluations" ON public.business_innovation_evaluations;
DROP POLICY IF EXISTS "Allow authenticated evaluators to update evaluations" ON public.business_innovation_evaluations;
DROP POLICY IF EXISTS "Allow authenticated reads evaluations" ON public.business_innovation_evaluations;
...
-- Business innovation evaluations policies
...
-- =========================================
-- 8. Create Storage Bucket for Receipts
-- =========================================
...
-- =========================================
-- 14. Add Sample Business Innovation Data
-- =========================================
